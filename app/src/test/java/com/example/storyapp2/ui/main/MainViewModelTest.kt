...
import com.example.storyapp2.utils.DataDummy
import com.example.storyapp2.utils.MainDispatcherRule
import com.example.storyapp2.utils.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val data: PagingData<ListStoryItem> = com.example.storyapp2.ui.main.StoryPagingSource.snapshot(dummyStory)
